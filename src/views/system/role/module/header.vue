<template>
  <div class="head-container">
    ...
    <div style="display: inline-block;margin: 0px 2px;">
      <el-button v-if="checkPermission(['ADMIN','ROLES_ALL','ROLES_CREATE'])" class="filter-item" size="mini" type="primary" icon="el-icon-plus" @click="$refs.form.dialog = true">新增</el-button>
  ...
  methods: {
    ...
    download() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['uuid', 'name', 'remark', 'createTime']
