<template>
  <div class="head-container">
    ...
    <div style="display: inline-block;margin: 0px 2px;">
      <el-button v-if="checkPermission(['ADMIN','USER_ALL','USER_CREATE'])" class="filter-item" size="mini" type="primary" icon="el-icon-plus" @click="add">新增</el-button>
  ...
  methods: {
    ...
    download() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['uuid', 'username', 'email', 'avatar', 'enabled', 'createTime', 'lastPasswordResetTime']
