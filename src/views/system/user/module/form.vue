...
export default {
  ...
  data() {
    ...
    return {
      dialog: false, loading: false, form: { name: '', username: '', email: '', enabled: 'false', roles: [], job: { uuid: '' }, dept: { uuid: '' }, phone: null },
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.jobId = null
      this.roleIds = []
      this.form = { name: '', username: '', email: '', enabled: 'false', roles: [], job: { uuid: '' }, dept: { uuid: '' }, phone: null }
    },
    getRoles() {
      getAll().then(res => {
        this.roles = res
