      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="6" :xl="5">
        <el-card class="box-card">
          ...
          <div>
            ...
            <ul class="user-info">
              <li>
                <svg-icon icon-class="userface" /> 用户姓名 <div class="user-right">{{ user.name }}</div>
              </li>
              <li>
                <svg-icon icon-class="user1" /> 登录名称 <div class="user-right">{{ user.username }}</div>
              </li>
              <li>
              ...
              <li>
                <svg-icon icon-class="dept" /> 所属部门 <div class="user-right"> {{ user.dept }} / {{ user.job }}</div>
              </li>
              <li>
